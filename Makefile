...
SDK_PATH = ../Nordic/sdk-6.1.0/nrf51822
SDK_SOURCE_PATH = $(SDK_PATH)/Source
SDK_INCLUDE_PATH = $(SDK_PATH)/Include

USE_LOADER := 0
USE_S110 := 1
SOFTDEVICE := ../Nordic/s110-7.0.0/s110_nrf51822_7.0.0_softdevice.hex

OBJECT_DIRECTORY := obj
LISTING_DIRECTORY := $(OBJECT_DIRECTORY)
OUTPUT_BINARY_DIRECTORY := build
OUTPUT_FILENAME := bootloader-dropng
...
INCLUDEPATHS += -I$(SDK_INCLUDE_PATH)/s110
...
$(OUTPUT_BINARY_DIRECTORY)/$(OUTPUT_FILENAME).elf: $(BUILD_DIRECTORIES) $(C_OBJECTS) $(ASSEMBLER_OBJECTS)
	$(CC) $(LDFLAGS) $(C_OBJECTS) $(ASSEMBLER_OBJECTS) -o $(OUTPUT_BINARY_DIRECTORY)/$(OUTPUT_FILENAME).elf
