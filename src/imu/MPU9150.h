...
#define MPU9150_ADDR            0b1101000
#define MPU9150_READ_BIT        TWI_READ_BIT

#define MPU9150_ISSUE_STOP      TWI_ISSUE_STOP
#define MPU9150_DONT_ISSUE_STOP TWI_DONT_ISSUE_STOP
